			...
			<div className="legal-container">
				<div className="legal-card">
					...
					<p className="legal-p">
						...
						descreve como coletamos, usamos, armazenamos e protegemos seus dados pessoais em conformidade com a Lei
					...
					<ul className="legal-ul">
						<li>
							<b>Identificação:</b> nome, e-mail corporativo, cargo/função (role)
						</li>
						<li>
							<b>Acesso:</b> credenciais de login (senha armazenada com criptografia bcrypt)
						</li>
						<li>
							<b>Perfil:</b> avatar, estado/região, vinculação com gestor/equipe
						</li>
						<li>
					...
					<p className="legal-p">
						O tratamento de dados pessoais é fundamentado no legítimo interesse da PayGas para gestão de capacitação de
						funcionários, cumprimento de obrigações regulatórias e auditoria interna, conforme art. 7º, IX da LGPD.
					</p>
					...
					<p className="legal-p">
						Gestores visualizam apenas dados dos atendentes de sua própria equipe. Atendentes não têm acesso a dados de
						outros usuários, exceto nome e pontuação em rankings públicos.
					</p>
					...
					<ul className="legal-ul">
						...
						<li>
							Controle de acesso baseado em roles (ADMIN, GESTOR, ATENDENTE, PARCEIRO_ACREDITADO, ERPS_REPRESENTANTE)
						</li>
					...
					<p className="legal-p">
						Seus dados são mantidos durante o período de vínculo com a PayGas. Após o desligamento, os dados de
						atividade e auditoria podem ser mantidos pelo prazo legal aplicável. Registros de progresso e certificados
						podem ser arquivados para fins de compliance.
					</p>
					...
					<p className="legal-p">
						A Plataforma utiliza armazenamento local (localStorage) para manter sua sessão ativa. Nenhum dado pessoal
						sensível é armazenado em cookies de terceiros.
					</p>
					...
					<p className="legal-p">
						Para exercer seus direitos ou tirar dúvidas sobre esta Política, entre em contato com a administração da
						Plataforma através do e-mail corporativo da PayGas.
					</p>
				</div>
			</div>
		</div>
