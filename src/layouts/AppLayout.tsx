				...
				<nav className={`sidebar ${sidebarOpen ? "open" : ""}`}>
					<div className="sidebar-section">
						...
						{isModuleEnabled("certificados") && (
							<button
								id="nav-certificados"
								className={`nav-item ${currentPath === "/certificados" ? "active" : ""}`}
								onClick={() => {
									setSidebarOpen(false);
						...
						<div className="sidebar-section">
							...
							{isAdmin && (
								<button
									...
									className={`nav-item ${currentPath === "/admin-dashboard" ? "active" : ""}`}
									onClick={() => {
										setSidebarOpen(false);
							...
							{isModuleEnabled("cms") && (
								<button
									id="nav-cms"
									className={`nav-item ${currentPath === "/cms" ? "active" : ""}`}
									onClick={() => {
										setSidebarOpen(false);
										navigate("/cms");
									}}
							...
							{isModuleEnabled("equipe") && isAdmin && (
								<button
									id="nav-equipe"
									className={`nav-item ${currentPath === "/equipe" ? "active" : ""}`}
									onClick={() => {
										setSidebarOpen(false);
										navigate("/equipe");
									}}
							...
							{isModuleEnabled("usuarios") && (
								<button
									id="nav-usuarios"
									className={`nav-item ${currentPath === "/usuarios" ? "active" : ""}`}
									onClick={() => {
										setSidebarOpen(false);
										navigate("/usuarios");
									}}
							...
							{isAdmin && (
								<button
									id="nav-logs"
									className={`nav-item ${currentPath === "/logs" ? "active" : ""}`}
									onClick={() => {
										setSidebarOpen(false);
										navigate("/logs");
									}}
					...
					<div className="sidebar-section">
						...
						{isModuleEnabled("notificacoes") && (
							<button
								id="nav-notif"
								className={`nav-item ${currentPath === "/notif" ? "active" : ""}`}
								onClick={() => {
									setSidebarOpen(false);
									navigate("/notif");
								}}
					...
					<div className="sidebar-footer">
						<div className="sidebar-user">
							<div className="user-avatar" style={{ background: persona?.color }}>
								{persona?.initials}
							</div>
