      ...
      {editingSettings && (
        <div className="quiz-settings-panel">
          ...
          <div className="quiz-settings-actions">
            <button className="btn-primary quiz-settings-action-btn" onClick={quiz ? handleUpdateSettings : handleCreateQuiz} disabled={saving}>
              {saving ? 'Salvando...' : quiz ? 'Salvar' : 'Criar Quiz'}
            </button>
            <button className="btn-secondary quiz-settings-action-btn" onClick={() => { setEditingSettings(false); if (!quiz) navigate(-1) }}>
              Cancelar
            </button>
          </div>
        </div>
        ...
        <div className="quiz-editor-main">
          <div className="quiz-editor-sidebar">
            <div className="quiz-editor-sidebar-header">
              <span className="quiz-editor-sidebar-title">
                ...
                quiz.perguntas.map((p: any, i: number) => (
                  ...
                  >
                    <div className="quiz-q-item-row">
                      <span className={`quiz-q-num ${activeQuestion === p.id ? 'active' : 'default'}`}>
                        {i + 1}
                      </span>
            ...
            <div className="quiz-editor-content-body">
              <div className="quiz-editor-content-max">
                <div className="form-field">
                  ...
                  <textarea className="form-input quiz-textarea" rows={3} value={formData.pergunta} onChange={e => setFormData({ ...formData, pergunta: e.target.value })} placeholder="Digite a pergunta..." />
                </div>
