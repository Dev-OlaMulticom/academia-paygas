...
export function LoginPage({ onLogin }: LoginPageProps) {
	...
	const renderForgotForm = () => (
		<>
			...
			<p className="login-desc">
				Informe o email da sua conta. Voce recebera um codigo de 6 digitos para redefinir sua senha.
			</p>
	...
	const renderCodeSentForm = () => (
		<>
			...
			<p className="login-desc">
				Um codigo de 6 digitos foi enviado para <strong>{resetEmail}</strong>. O codigo expira em 15 minutos.
			</p>
			{resetError && <div className="login-alert error">{resetError}</div>}
			{resetSuccess && <div className="login-alert success">{resetSuccess}</div>}
			<div className="field">
			...
			<div className="login-resend">
				<button type="button" className="login-link-btn" onClick={handleForgotPassword}>
					Reenviar codigo
				</button>
			</div>
		</>
			...
			<div className="modal-card" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 420 }}>
				...
				<div className="field">
					...
					<input
						...
						value={payGasInput}
						onChange={(e) =>
							setPayGasInput(payGasType === "cpf" ? formatCpf(e.target.value) : formatEmail(e.target.value))
						}
		...
		<div id="screen-login">
			<div className="login-panel">
				...
				<p className="login-terms">
					Ao acessar, voce concorda com os <Link to="/termos">Termos de Uso</Link> e a{" "}
