    ...
    <div className="page active">
      ...
      <div className="two-col">
        <div>
          <div className="perfil-card">
            <div className="perfil-user-row">
              <div className="user-avatar perfil-avatar-lg">
          ...
          <div className="perfil-card">
            ...
            <div className="form-field">
              ...
              <input className="form-input" type="password" placeholder="Digite sua senha atual" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} />
            </div>
            <div className="form-field">
              <label className="form-label">Nova Senha</label>
              <input className="form-input" type="password" placeholder="Minimo 8 caracteres" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
            </div>
            <div className="form-field">
        ...
        <div>
          ...
          {isAdmin && (
            <div className="perfil-card">
              <div className="section-title perfil-sandbox-title">
                  ...
                  return (
                    <div key={u.email} className="perfil-demo-item">
                      ...
                      <div className="perfil-demo-right">
                        <span className="perfil-demo-role" style={{ background: personaColor }}>{u.role}</span>
      ...
      <div className="perfil-footer">
        <Link to="/termos" className="perfil-footer-link">Termos de Uso</Link>
        <span className="perfil-footer-dot">·</span>
        <Link to="/privacidade" className="perfil-footer-link">Política de Privacidade</Link>
      </div>
    </div>
  )
}